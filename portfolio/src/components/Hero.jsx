...
export default function Hero({ text, imgUrl }) {
    ...
    return (
        <div className={`relative h-screen w-screen max-w-full mb-20 border-gray-900/50`}>
            <div className="px-10 h-full max-w-full flex">
                <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 h-full">
                    ...
                    <div className="my-auto">
                        <p className={`text-blue-300 shadow-blue-300 font-special-gothic text-8xl sm:text-9xl ${animate ? 'fade-in-up' : 'opacity-0'}`}>
                            {text}
                        </p>
                    </div>
